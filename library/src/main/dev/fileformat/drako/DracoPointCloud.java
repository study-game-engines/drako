...
{    
     ...
     *
     * @param type What type of attribute to count, defined by {@link dev.fileformat.drako.AttributeType}
     * @return The number of attributes in given type.
     */
     ...
     *
     * @param type What type of attribute to find, defined by {@link dev.fileformat.drako.AttributeType}
     * @return The id of the first named attribute in given type
     */
     ...
     * @param type What type of attribute to find, defined by {@link dev.fileformat.drako.AttributeType}
     * @param i Index of the attribute.
     * @return The instance of the i-th named attribute in given type
     */
     ...
     *
     * @param type What type of attribute to find, defined by {@link dev.fileformat.drako.AttributeType}
     * @param customId Custom id of the attribute.
     * @return The instance of named attribute with given custom id
     */
     ...
     *
     * @param pa The new attribute to be added
     ...
     *
     * @param att The instance of attribte to be added
     * @param identityMapping Whether to use identity mapping between point indices and attribute value indices.
     * @param numAttributeValues Specify the number of attribute values that will be stored in the new attribute.
     * @return The index of the new attribute.
     */
